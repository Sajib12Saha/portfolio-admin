...
export const RichTextEditor = ({
  ...
  return (
    <div className="space-y-2">
      ...
      {/* Editor Content */}
<div className="w-full rounded-md border bg-input px-3 py-2 text-sm text-foreground shadow-[inset_3px_3px_3px_rgba(0,0,0,0.25),inset_-1px_-1px_4px_rgba(255,255,255,0.8)] dark:shadow-[inset_3px_3px_3px_rgba(0,0,0,0.25),inset_-1px_-1px_4px_rgba(255,255,255,0.16)]">
  <EditorContent editor={editor} className="tiptap dark" />
</div>
