...
export const RichTextEditor = ({
  ...
  return (
    <div className="space-y-2">
      {/* Toolbar */}
      <div className="flex flex-wrap gap-2 md:gap-4 px-3 py-2 rounded-md bg-input overflow-x-hidden shadow-[inset_3px_3px_3px_rgba(0,0,0,0.25),inset_-1px_-1px_4px_rgba(255,255,255,0.8)] dark:shadow-[inset_3px_3px_3px_rgba(0,0,0,0.25),inset_-1px_-1px_4px_rgba(255,255,255,0.16)]">
        <Button
          type="button"
          size="sm"
